...
var jogadores = [
    ...
    // { mensalista: "não" },
    { nome: "Du", posicao: "Meia", mensalista: "não" },//9
...
function sortearTimes() {
    ...
    var p1 = shuffle(selecaoJogadores.slice(2, 4));
    // var p2 = shuffle(selecaoJogadores.slice(6, 12));
    var p2 = shuffle(selecaoJogadores.slice(4, 14));
    ...
    var jogadoresLaranja = [...p1.slice(0, 1), ...p2.slice(0, 5), ...p3.slice(0, 1)]
    // var jogadoresLaranja = [...p1.slice(0, 3), ...p2.slice(5)]
    // var jogadoresPreto = [...p1.slice(2), ...p2.slice(3), ...p3.slice(2)]
    var jogadoresPreto = [...p1.slice(1), ...p2.slice(5), ...p3.slice(1)]
